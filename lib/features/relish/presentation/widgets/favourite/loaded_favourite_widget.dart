    ...
    return Obx(() => StaggeredGridView.countBuilder(
        ...
        itemBuilder: (context, index) {
          final product = Controllers.productController.products
              .where((product) =>
                  product.productId ==
                  Controllers.favouriteController.favourites[index].productId)
              .single;
          // final kitchen = Controllers.kitchenController.kitchens
          //     .where((kitchen) =>
          //         kitchen.kitchenId ==
          //         Controllers.favouriteController.favourites[index].kitchenId)
          // .single;
          return InkWell(
              onTap: () {
                // Get.to(() => Home(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: CachedNetworkImageProvider(
                                    ApiUrl.STORAGE_URL + product.productImage),
                                fit: BoxFit.cover,
                              ),
