...
class ApiUrl {
  ...
  static const String UPDATE_USER_PROFILE = '${BASE_URL}profile';
  ...
  static const String CART_URL = '${BASE_URL}cart-items';
  static const String GET_CART_CONTENT_URL = '${BASE_URL}cart-content';
